...
public class ComplexUtils {
    ...
    static void generalPointwiseOperateRe(final Object a, final Object b, final NumericalRoutines.Operation operation) {
    ...
    public static void pointwiseOperate(final float[] a, final float[] b, final NumericalRoutines.Operation operation) {
	generalPointwiseOperateFl(a, b, operation);
    }

    private static void generalPointwiseOperateFl(final Object a, final Object b,
	    final NumericalRoutines.Operation operation) {
    ...
    /** ApplyMask. @@@ */
    public static void applyMask(final double[][][] a, final double[][][] mask) {
    ...
    public static double[] getCompareValuesRe(final double[][][][][][] a, final double[][][][][][] b,
    ...
    public static double[] getCompareValuesRe(final double[][][][] a, final double[][][][] b, final double threshold) {
	return generalCompareValuesRe(a, b, threshold, null);
    }
    ...
    private static double[] generalCompareValuesRe(final Object a, final Object b, final double threshold,
	    double[] returnValues) {
	if (returnValues == null) {
	    /** nZeroes, nTotal, minNonZero, max. */
	    returnValues = new double[] { 0, 0, Double.POSITIVE_INFINITY, 0 };
	}
	final int[] dims = getDims(a);
	final int nDims = dims.length;
	final int dim = dims[0];
    ...
    public static float[] getCompareValuesFl(final float[][][][][] a, final float[][][][][] b, final float threshold) {
	return generalCompareValuesFl(a, b, threshold, null);
    }
    ...
    private static float[] generalCompareValuesFl(final Object a, final Object b, final float threshold,
	    float[] returnValues) {
	if (returnValues == null) {
	    /** nZeroes, nTotal, minNonZero, max. */
	    returnValues = new float[] { 0, 0, Float.POSITIVE_INFINITY, 0 };
	}
	final int[] dims = getDimsFl(a);
	final int nDims = dims.length;
	final int dim = dims[0];
    ...
    /** getConstArrays. */
    public static double[][][][][][] getConstArrayRe6(final int[] dims, final double c) {
	return (double[][][][][][]) generalGetConstArrayRe(dims, c);
    }

    public static double[][][][][] getConstArrayRe5(final int[] dims, final double c) {
	return (double[][][][][]) generalGetConstArrayRe(dims, c);
    }

    public static double[][][][] getConstArrayRe4(final int[] dims, final double c) {
	return (double[][][][]) generalGetConstArrayRe(dims, c);
    }

    public static double[][][] getConstArrayRe3(final int[] dims, final double c) {
	return (double[][][]) generalGetConstArrayRe(dims, c);
    }

    public static double[][] getConstArrayRe2(final int[] dims, final double c) {
	return (double[][]) generalGetConstArrayRe(dims, c);
    }
    ...
    private static Object generalGetConstArrayRe(final int[] dims, final double c) {
	final int nDims = dims.length;
	final int dim = dims[0];
	if (nDims == 1) {
    ...
    public static int[][][][][][] getConstArrayI6(final int[] dims, final int c) {
    ...
    private static void generalScalarOperate(final Object a, final double scalar,
	    final NumericalRoutines.Operation operation) {
	final int[] dims = getDims(a);
	final int nDims = dims.length;
	final int dim = dims[0];
