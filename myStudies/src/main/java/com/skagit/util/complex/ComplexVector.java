...
class ComplexVector {
    ...
    /** No conjugation here. */
    ComplexVector pointwiseOperate(final ComplexVector vector, final NumericalRoutines.Operation operation,
    ...
    ComplexVector scalarOperate(final Complex complex, final NumericalRoutines.Operation operation,
	    final boolean inPlace) {
	final int m = getM();
