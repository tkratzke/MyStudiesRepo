...
public class NumericalUtils {
	...
	public static <T extends Object> int getGlbIndex(final T[] tArray, final T t,
		...
		/**
		 * We now know that tArray[j] <= t. Increase j until array[j] > t, and return j - 1.
		 */
	...
	public static boolean relativeErrorIsSmall(final double d0, final double d1,
