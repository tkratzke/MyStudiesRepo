...
public class ConwayDayOfWeek {
	...
	final private static int[] _KeyDaysOfMonth = new int[] {
			-1, // Dummy so we can use 1-12 to index this array.
	...
	final private static DayOfWeek[] _Anchors = {
			DayOfWeek.TUESDAY, DayOfWeek.SUNDAY, DayOfWeek.FRIDAY, DayOfWeek.WEDNESDAY
	};
	...
	public static void main(final String[] args) {
		final String[] dateStrings = new String[] {
				"1900-01-01", //
				"1900-01-02", //
				"1900-02-28", //
				"1900-03-01", //
