...
public class MtvGameWithStrings extends MtvGame {
	...
	public MtvGameWithStrings(final String[][] pairs, final int kPerm0,
			final Random r) {
		...
		NextNToUse: for (int nToUse = 1;; ++nToUse) {
			...
			for (int k = 0; k < nPairs; ++k) {
				final String[] pair = pairs[k];
				final String s0 =
						pair[0].substring(0, Math.min(nToUse, pair[0].length()));
				final String s1 =
						pair[1].substring(0, Math.min(nToUse, pair[1].length()));
	...
	private LittleClue createLittleClue(final String[] pair,
			final boolean right) {
		...
		if (int0 == null || int0 < 0 || int0 >= nPairs || int1 == null ||
				int1 < 0 || int1 >= nPairs) {
			return null;
		}
	...
	private BigClue createBigClue(final String[][] pairs, final int nRight) {
		final int nPairs = getNPairs();
		if (pairs == null || pairs.length != nPairs || nRight < 0 ||
				nRight > nPairs) {
			return null;
		}
		for (int k = 0; k < nPairs; ++k) {
			final String[] thisPair = pairs[k];
			if (thisPair.length < 2 || thisPair[0] == null ||
					thisPair[1] == null) {
				return null;
			}
	...
	public String getString() {
		...
		for (int k = 0; k < nPairs; ++k) {
			...
			for (int k1 = _aSide[k].nextSetBit(0), k2 = 0; k1 >= 0;
					k1 = _aSide[k].nextSetBit(k1 + 1), ++k2) {
	...
	private String getLittleClueString(final LittleClue littleClue) {
		...
		return String.format("[%s,%s:%c]", aString, bString,
				littleClue._right ? 'Y' : 'N');
	}
	...
	public static void main(final String[] args) {
		...
		final MtvGameWithStrings mtvGameWithStrings =
				new MtvGameWithStrings(stringPairs, kPerm0, r);

		final Clue[][] rounds = new Clue[][] { //
				/* ROUND ONE */
				new Clue[] { //
						mtvGameWithStrings.createLittleClue(
								new String[] { "Chris", "Shanley" }, false), //
				...
				new Clue[] {
						mtvGameWithStrings
								.createLittleClue(new String[] { "Ethan", "Jess" }, false), //
						mtvGameWithStrings.createBigClue(new String[][] { //
								{ "John", "Jacy" }, //
								{ "Dillon", "Jess" }, //
								{ "Chris", "Paige" }, //
				...
				new Clue[] {
						mtvGameWithStrings
								.createLittleClue(new String[] { "John", "Simone" }, false), //
						mtvGameWithStrings.createBigClue(new String[][] { //
								{ "Dillon", "Coleysia" }, //
								{ "John", "Jess" }, //
								{ "Ryan", "Kayla" }, //
				...
				new Clue[] {
						mtvGameWithStrings
								.createLittleClue(new String[] { "Dillon", "Jess" }, false), //
						mtvGameWithStrings.createBigClue(new String[][] { //
								{ "Dillon", "Coleysia" }, //
								{ "Scali", "Paige" }, //
								{ "Wes", "Jess" }, //
				...
				new Clue[] {
						mtvGameWithStrings.createLittleClue(
								new String[] { "Dre", "Ashleigh" }, false), //
						mtvGameWithStrings.createLittleClue(
								new String[] { "Dillon", "Coleysia" }, true), //
						mtvGameWithStrings.createBigClue(new String[][] { //
								{ "Dillon", "Coleysia" }, //
								{ "Ethan", "Amber" }, //
								{ "Joey", "Jess" }, //
				...
				new Clue[] {
						mtvGameWithStrings
								.createLittleClue(new String[] { "Chris", "Paige" }, true), //
						mtvGameWithStrings.createBigClue(new String[][] { //
								{ "Dillon", "Coleysia" }, //
								{ "Chris", "Paige" }, //
								{ "John", "Jacy" }, //
				...
				new Clue[] {
						mtvGameWithStrings
								.createLittleClue(new String[] { "Ryan", "Kayla" }, false), //
						mtvGameWithStrings.createBigClue(new String[][] { //
								{ "Dillon", "Coleysia" }, //
								{ "Chris", "Paige" }, //
								{ "Wes", "Kayla" }, //
				...
				new Clue[] {
						mtvGameWithStrings
								.createLittleClue(new String[] { "Wes", "Kayla" }, true), //
						mtvGameWithStrings.createBigClue(new String[][] { //
								{ "Dillon", "Coleysia" }, //
								{ "Chris", "Paige" }, //
								{ "Wes", "Kayla" }, //
				...
				new Clue[] {
						mtvGameWithStrings
								.createLittleClue(new String[] { "John", "Jacy" }, false), //
						mtvGameWithStrings.createBigClue(new String[][] { //
								{ "Dillon", "Coleysia" }, //
								{ "Chris", "Paige" }, //
								{ "Wes", "Kayla" }, //
		...
		ROUND_LOOP: for (int kRound = 0; kRound < nRounds; ++kRound) {
			...
			final int nCluesInRound =
					cluesInRound == null ? 0 : cluesInRound.length;
			for (int kClue = 0; kClue < nCluesInRound; ++kClue) {
				...
				if (clue instanceof MtvGame.LittleClue) {
					System.out.printf("Round %d, LittleClue %s yields\n%s",
							kRound + 1,
							mtvGameWithStrings.getLittleClueString((LittleClue) clue),
							mtvGameWithStrings.getString());
					printedOneA = printedOneB = true;
				} else if (clue instanceof BigClue) {
					System.out.printf("Round %d, BigClue %s yields\n%s", kRound + 1,
							mtvGameWithStrings.getBigClueString((BigClue) clue),
							mtvGameWithStrings.getString());
					printedOneA = printedOneB = true;
				}
