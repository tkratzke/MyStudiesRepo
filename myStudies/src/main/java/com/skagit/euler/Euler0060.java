...
public class Euler0060 {
	...
	private void extendBox() {
		final int newEndOfBox = _winningSum == _UnsetWinningSum
				? (2 * _endOfBox + 1)
				: _winningSum;
	...
	public static void main(final String[] args) {
		...
		System.out.printf(" %s, sum=%d, took %02d:%02d:%02d.",
				StringUtils.getString(euler0060._winningVector), euler0060._winningSum, hrs,
				mints, secs);
	}
