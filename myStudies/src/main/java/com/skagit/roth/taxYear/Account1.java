...
public class Account1 extends NamedEntity {
	...
	_pvsAccount1 = rothCalculator.getAccount1(account0, thisYear - 1);
	if (_pvsAccount1 == null) {
	    _initialBalance = account0._balanceBeginningOfBaseYear;
	} else {
	    _initialBalance = _pvsAccount1._finalBalance;
	}
	if (owner0 == null) {
	    _rmd = 0d;
	} else {
	...
	String s = String.format("Account1[%s], InitBlnc[%s]", _name, //
